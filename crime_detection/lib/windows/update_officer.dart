...
class UpdateOfficer extends StatefulWidget {
  const UpdateOfficer(
      {super.key,
  ...
  @override
  State<UpdateOfficer> createState() => _UpdateOfficerState();
}

class _UpdateOfficerState extends State<UpdateOfficer> {
  ...
  Widget build(BuildContext context) {
    ...
    _post.text = widget.post;
    _qualification.text = widget.qualification;
